...
idempotenceCard.addEventListener("click", () => {
  showAlert(`<h3>Idempotence</h3><p>A ∧ A ≡ A</p><p>A ∨ A ≡ A</p>
    ...
    <img class="exampleOfRule" src="/logic-tool/images/idempotence.png" alt="Idempotence applied in reverse">
...
commutativityCard.addEventListener("click", () => {
  showAlert(`<h3>Commutativity</h3><p>A ∧ B ≡ B ∧ A</p><p>A ∨ B ≡ B ∨ A</p><p>The commutativity rule can be used
    ...
    <img class="exampleOfRule" src="/logic-tool/images/commutativity.png" alt="Commutativity applied in reverse">
...
associativityCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/associativityReverse.png" alt="Associativity applied in reverse">
  <img class="exampleOfRule" src="/logic-tool/images/associativityComplex.png" alt="Associativity applied">
...
absorptionCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/absorptionReverse.png" alt="Absorption applied in reverse">
  <img class="exampleOfRule" src="/logic-tool/images/absorption2.png" alt="Absorption applied in reverse">
...
distributivityCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/distributivity.png" alt="Complex example of distributivity">`);
});
...
negationCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/negation.png" alt="Example of negation">`);
});
...
doubleNegationCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/doubleNegation.png" alt="Example of double negation">`);
});
...
deMorganCard.addEventListener("click", () => {
  ...
  computer programs and circuit design. The rules can be described as 'not (A or B) = not A and not B; and
    ...
    <img class="exampleOfRule" src="/logic-tool/images/deMorgan.png" alt="Example of de Morgan rule">`);
});
...
implicationCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/implication.png" alt="Example of implication rule">`);
});
...
biImplicationCard.addEventListener("click", () => {
  ...
  <img class="exampleOfRule" src="/logic-tool/images/biImplication.png" alt="Example of bi-implication rule">`);
});
